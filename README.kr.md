...
[![최신 릴리스](https://img.shields.io/github/v/release/kkorenn/Quartz?include_prereleases&sort=date&label=release&logo=github)](https://github.com/kkorenn/Quartz/releases/latest)
[![다운로드](https://img.shields.io/github/downloads/kkorenn/Quartz/total?logo=github&label=downloads)](https://github.com/kkorenn/Quartz/releases)
[![스타](https://img.shields.io/github/stars/kkorenn/Quartz?logo=github)](https://github.com/kkorenn/Quartz/stargazers)
[![디스코드](https://img.shields.io/discord/1499236885409566891?logo=discord&logoColor=white&label=Discord&color=5865F2)](https://discord.gg/mAzAghu5Xq)
</div>
...
0. [modlist.org app](https://github.com/modlist-org/modlist_org_app/releases/latest)과 [Quartz](https://github.com/kkorenn/Quartz/releases/latest) 다운로드
...
0. MelonLoader가 설치되어 있는지 확인하세요 (그렇지 않다면: [추천](https://github.com/kkorenn/Quartz#install--melonloader-recommended))
1. [최신 릴리스](https://github.com/kkorenn/Quartz/releases/latest)에서 `Quartz.zip`을 다운로드 하세요.
...
1. [최신 릴리스](https://github.com/kkorenn/Quartz/releases/latest)에서 `QuartzUmm.zip`을 다운로드 하세요.
...
![크레딧](readme/credits.png)
![게임플레이](readme/ingame.png)
